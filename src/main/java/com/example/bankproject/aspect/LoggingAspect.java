package com.example.bankproject.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.example.bankproject.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * com.example.bankproject.service.*.*(..))")
